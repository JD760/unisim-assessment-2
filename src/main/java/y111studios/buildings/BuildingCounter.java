...
/**
 * A counter class to keep track of the number of buildings. This class keeps
...
public class BuildingCounter {
   ...
   * @param type the type of building for which the corresponding counter should be incremented.
   */
