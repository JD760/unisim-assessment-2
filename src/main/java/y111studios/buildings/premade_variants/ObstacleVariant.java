...
public enum ObstacleVariant implements VariantProperties {
  ...
  OBSTACLE1(12, 14, 11, 35,
    AssetPaths.OBSTACLE1, "obstacle1", AssetPaths.OBSTACLE1SNOW, AssetPaths.OBSTACLE1FLOOD),
  OBSTACLE2(8, 12, 55, 49,
    AssetPaths.OBSTACLE2, "obstacle2", AssetPaths.OBSTACLE2SNOW, AssetPaths.OBSTACLE2FLOOD),
  OBSTACLE3(7, 7, 15, 16,
    AssetPaths.OBSTACLE3, "obstacle3", AssetPaths.OBSTACLE3SNOW, AssetPaths.OBSTACLE3FLOOD),
  OBSTACLE4(17, 19, 43, 12,
    AssetPaths.OBSTACLE4, "obstacle4", AssetPaths.OBSTACLE4SNOW, AssetPaths.OBSTACLE4FLOOD);
  ...
  ObstacleVariant(int width, int height, int posX, int posY, AssetPaths texturePath, String name) {
    this.width = width;
    this.height = height;
