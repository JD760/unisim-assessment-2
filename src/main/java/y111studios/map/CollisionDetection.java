 ...
 * 
 * <p>
 * The collision detection class is used to determine if a building can be
 * placed on the map given a
 * position and area. The class also provides methods for updating the internal
 * data of this class
...
public class CollisionDetection {
  /**
   * Boolean array representing the grid of the map. This is a false initialized
   * grid where true
  ...
  /**
   * Mark an area on the grid as filled.
   *
   * @param width - The width of the grid area
   * @param height - The height of the grid area
   * @param staticObjects - An array of objects to have their areas filled
   */
   ...
   * @return true if the building will have valid bounds if placed on the map,
   *         false otherwise
   */
  ...
  /**
   * Checks if the given position is a valid place to build. This method checks
   * only a single
   * cell.
   *
   * @param position the position to check
  ...
  /**
   * Attempts to place a building on the grid in the given area. If the building
   * can be placed, it
